...
'./api/cpp/lars_api',
'-I',
'./base/mysql-connector-c/include',
'-I',
'./base/mysql-connector-c/include/mysql',
'-I',
'./base/mysql-connector-c/include/mysql/psi',
'-I',
'./base/proto',
'-I',
'./lars_dns/include',
'-I',
'./lars_lb_agent/include',
'-I',
'./lars_reactor/example/qps_test',
'-I',
'./lars_reactor/include',
'-I',
'./lars_reporter/include',
]
